    ...
    <nav className="bg-[#090909] py-4 px-6 lg:px-8 border-b border-[#202020]">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-8">
          ...
          <Link href="/page-manager" className="text-[#828288] hover:text-[#EDECF8] transition-colors text-sm font-medium">
            Manager
          </Link>
          <Link href="/page-editor" className="text-[#828288] hover:text-[#EDECF8] transition-colors text-sm font-medium">
            Editor
          </Link>
        </div>
